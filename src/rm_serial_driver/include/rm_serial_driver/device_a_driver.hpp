...
#ifndef RM_SERIAL_DRIVER__DEVICE_A_DRIVER_HPP_
#define RM_SERIAL_DRIVER__DEVICE_A_DRIVER_HPP_
...
class DeviceADriver : public RMSerialDriver
{
public:
    explicit DeviceADriver(const rclcpp::NodeOptions &options);
...
#endif  // RM_SERIAL_DRIVER__DEVICE_A_DRIVER_HPP_
